...
#SBATCH --job-name=Psi4RunA          #Name of the job
...
#SBATCH --error=SLURM_Psi4RunA_%j.err         #Name of error file
#SBATCH --output=SLURM_Psi4RunA_%j.out        #Name of output file

ulimit -u 32768
echo "Job $SLURM_JOB_ID running on SLURM NODELIST: $SLURM_NODELIST "
module load ccs/conda/ocelot
. ~/.bashrc
